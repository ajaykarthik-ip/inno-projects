...
const SidebarMenu: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { type: 'link', name: 'Machine Learning', icon: 'brain',      path: '/machine-learning-projects-coimbatore' },
    { type: 'link', name: 'CSE Projects',     icon: 'code',       path: '/cse-final-year-projects-coimbatore' },
    { type: 'link', name: 'ECE Projects',     icon: 'cpu',        path: '/ece-final-year-projects-coimbatore' },
    { type: 'link', name: 'MCA Projects',     icon: 'graduation', path: '/mca-final-year-projects-coimbatore' },
    { type: 'link', name: 'Python',           icon: 'terminal',   path: '/python-projects-coimbatore' },
    { type: 'link', name: 'Web Development',  icon: 'globe',      path: '/web-development-projects-coimbatore' },
    { type: 'link', name: 'IoT Projects',     icon: 'wifi',       path: '/ece-final-year-projects-coimbatore' },
    { type: 'link', name: 'IEEE Projects',    icon: 'file-text',  path: '/ieee-projects-coimbatore-2026' },
    { type: 'link', name: 'Blockchain',       icon: 'blockchain', path: '/cse-final-year-projects-coimbatore' },
    { type: 'link', name: 'PHP Projects',     icon: 'database',   path: '/web-development-projects-coimbatore' },
    { type: 'link', name: 'Java Projects',    icon: 'coffee',     path: '/mca-final-year-projects-coimbatore' },
    { type: 'link', name: 'Hardware',         icon: 'tool',       path: '/ece-final-year-projects-coimbatore' },
  ];
  ...
  const renderIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'graduation':
        return (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <line x1="22" y1="10" x2="22" y2="16"></line>
          </svg>
        );
      case 'terminal':
        return (
      ...
      case 'wifi':
        return (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M2 8.8a16 16 0 0 1 20 0"></path>
            <path d="M5 12.4a11 11 0 0 1 14 0"></path>
      ...
      case 'blockchain':
        return (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <rect x="4" y="3.5" width="6" height="6" rx="1"></rect>
            <rect x="14" y="3.5" width="6" height="6" rx="1"></rect>
            <rect x="9" y="14.5" width="6" height="6" rx="1"></rect>
            <path d="M10 6.5h4M7 9.5l3.5 5M17 9.5l-3.5 5"></path>
          </svg>
        );
      case 'database':
        return (
